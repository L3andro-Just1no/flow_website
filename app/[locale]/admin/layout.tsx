...
export default async function AdminLayout({
  ...
  // If Supabase is not configured, show warning
  if (!supabase) {
    return (
      <div className="min-h-screen bg-gray-100 flex items-center justify-center p-4">
        <div className="bg-white rounded-lg shadow-lg p-8 max-w-2xl">
          ...
          <p className="mb-4">
            The admin panel requires Supabase to be configured. Please set up your environment variables in <code className="bg-gray-100 px-2 py-1 rounded">.env.local</code>:
          </p>
...
SUPABASE_SERVICE_ROLE_KEY=your-service-role-key`}
          ...
          <p className="text-sm text-gray-600">
            See <strong>QUICKSTART.md</strong> for setup instructions.
          </p>
        </div>
      </div>
    );
